...
{
    //Code Helped By:
    //https://github.com/Gainedge/BetterExplorer/blob/master/ShellControls/RangeObservableCollection.cs

    /// <summary>
    /// The All In One List That Has Everything You Need!
    /// </summary>
    /// <see href="MK 1.0"/>
    /// <remarks>
    /// Mostly To Shortan ObservableCollection Down With Some Mothods List Object.
    /// </remarks>
    /// <typeparamref name="T"/>
    public class ExList<T> : ObservableCollection<T>
    {
        /// <summary>
        /// Initializes a new instance of ExList that is empty and has default initial capacity.
        /// </summary>
        public ExList() : base() { }

        /// <summary>
        /// Initializes a new instance of the ExList class that contains
        /// elements copied from the specified collection and has sufficient capacity
        /// to accommodate the number of elements copied.
        /// </summary>
        /// <param name="collection">The collection whose elements are copied to the new list.</param>
        /// <remarks>
        /// The elements are copied onto the ExList in the
        /// same order they are read by the enumerator of the collection.
        /// </remarks>
        /// <exception cref="ArgumentNullException"> collection is a null reference </exception>
        public ExList(IEnumerable<T> collection) : base(CreateCopy(collection, nameof(collection))) { }
        ...
        /// <returns><see href="true"/> If All Element Matches The Conditions, Otherwise <see href="false"/></returns>
        public bool TrueForAll(Predicate<T> predicate) => this.All(x => predicate(x));

        /// <summary>
        /// Sorts the elements in the entire List or a portion of it using either 
        /// a specified comparer or a specified comparison method.
        /// </summary>
        ...
        /// <param name="count">Amount Of Element To Sort</param>
        /// <param name="comparer"></param>
        ...
        public void Sort(int index, int count, IComparer<T> comparer)
        {
            ...
            if (count - index < count) throw new ArgumentOutOfRangeException(nameof(count));

            if (count > 1) Array.Sort<T>(this.ToArray(), index, count, comparer);
        }
        ...
        /// <returns>The List In The Converted Type.</returns>
        public ExList<Tout> ConvertAll<Tout>(Converter<T, Tout> converter) => this.Select(x => converter(x)).ToExList();
        ...
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns>The Element, Otherwice NULL</returns>
        public T Find(Predicate<T> predicate) => this.FirstOrDefault(x => predicate(x));
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public T FindLast(Predicate<T> predicate) => this.LastOrDefault(x => predicate(x));
        /// <summary>
        /// Retrieves all the elements that match the conditions defined by the specified predicate.
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns>The Last Element, Otherwice NULL</returns>
        public ExList<T> FindAll(Predicate<T> predicate) => this.Where(x => predicate(x)).ToExList();

        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the first occurrence within the entire List or a portion of it.
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns>The Index Of The Element</returns>
        public int FindIndex(Predicate<T> predicate) => FindIndex(0, Count, predicate);
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the first occurrence within the entire List or a portion of it.
        /// </summary>
        ...
        /// <returns>The Index Of The Element</returns>
        public int FindIndex(int startIndex, Predicate<T> predicate) => FindIndex(startIndex, Count, predicate);
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the first occurrence within the entire List or a portion of it.
        /// </summary>
        ...
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the last occurrence within the entire List or a portion of it.
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns>The Index Of The Last Element</returns>
        public int FindLastIndex(Predicate<T> predicate) => FindIndex(Count, Count, predicate);
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the last occurrence within the entire List or a portion of it.
        /// </summary>
        ...
        /// <param name="predicate"></param>
        /// <returns>The Index Of The Last Element</returns>
        public int FindLastIndex(int startIndex, Predicate<T> predicate) => FindIndex(startIndex, Count, predicate);
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified predicate, 
        /// and returns the zero-based index of the last occurrence within the entire List or a portion of it.
        /// </summary>
        ...
        /// </summary>
        /// <param name="index">Start Index</param>
        /// <param name="count">Amount Of Elemnt</param>
        /// <returns></returns>
        /// <exception cref="ArgumentOutOfRangeException"></exception>
        ...
        /// <summary>
        /// Bach Adds Elements To List.
        /// </summary>
        /// <param name="list">A List Of Elements To Add.</param>
        ...
        {
            readonly ExList<T> _collection;
            public DeferredEventsCollection(ExList<T> collection)
            {
